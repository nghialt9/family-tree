...
.toolbar { display: flex; align-items: center; justify-content: space-between; padding: 10px 20px; background: #ffffff; border-bottom: 1px solid #d0d7de; height: 52px; flex-shrink: 0; z-index: 10; }
.app-title { font-size: 1rem; font-weight: bold; color: #24292f; }
.toolbar-actions { display: flex; gap: 10px; }
.btn-add { background: #2da44e; color: #fff; border: none; border-radius: 6px; padding: 8px 16px; cursor: pointer; font-size: 13px; font-weight: 500; }
.btn-add:hover { background: #2c974b; }
.btn-logout { background: #f6f8fa; color: #57606a; border: 1px solid #d0d7de; border-radius: 6px; padding: 8px 16px; cursor: pointer; font-size: 13px; }
